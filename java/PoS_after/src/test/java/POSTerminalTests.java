...
class POSTerminalTests {

    @Test
    void VerifySale_AmountUnderSingleChargeLimit_IsApproved() {
    ...
    void VerifySale_ViaMock_AmountUnderSingleChargeLimit_IsApproved() {
    ...
    static class MockCCVerifier implements ICCVerifier {
